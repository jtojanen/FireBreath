...
namespace FB
{
    namespace DOM
    {
        ...
        **/
        ...
        {
        public:
            explicit Node(const JSObjectPtr& element);
            virtual ~Node();
        ...
        public:
            ...
            /// @return child node
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            virtual NodePtr getNode(int idx) const;
            ...
            /// @overload
            virtual void setProperty(int idx, const variant& val) const;
